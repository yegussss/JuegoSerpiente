...
Game.Load.prototype = {
  preload: function() {
    ...
    game.load.audio('music', 'sounds/uzi.mp3');
    game.load.audio('coin', 'sounds/coin.wav');
    game.load.audio('death', 'sounds/dead.mp3');
  },
  create: function() {
...
Game.Menu.prototype = {
  create: function() {
    ...
    var label = game.add.text(w / 2, h / 2 - 100, 'Snakes & Death', {
      font: '60px Arial',
      fill: '#2c2c2c',
      align: 'center'
    });
    ...
    var label = game.add.text(w / 2, h - 150, 'Presiona la flecha para arriba y empieza.', {
      font: '25px Arial',
      fill: '#2c2c2c'
    });
    label.anchor.setTo(0.5, 0.5);
...
Game.End.prototype = {
  create: function() {
    ...
    if (score > best_score)
      best_score = score;
    this.cursor = this.game.input.keyboard.createCursorKeys();
    var label = game.add.text(w / 2, h / 2 - 100, 'Perdiste :(', {
      font: '60px Arial',
      fill: '#fff',
      align: 'center'
    });
    ...
    var label2 = game.add.text(w / 2, h - 220, 'Puntos: ' + score + '\nMejor puntuación: ' + best_score, {
      font: '25px Arial',
      fill: '#fff',
      align: 'center'
    });
    ...
    var label3 = game.add.text(w / 2, h - 120, 'Presiona la flecha hacia arriba y reinicia', {
      font: '25px Arial',
      fill: '#fff',
      align: 'center'
    });
